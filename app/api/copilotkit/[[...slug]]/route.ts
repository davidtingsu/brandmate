...
Step 1 — Create post: User generates via the guided panel. Profile onboarding is already complete. Coach them to refine with retryWithJudgeFeedback and regeneratePost. When the user adds revision notes in chat, pass them as userFeedback — revisions auto-store voice lessons in Redis. Do not approve until Step 2.
